        ...
        <div className='font-poppins'>
            ...
            <section>
                ...
                <div className='py-24 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-8 gap-24'>
                    <div className=' relative group'>
                        <div className='border-2 transition-all duration-300 group-hover:bg-[#285BDB] absolute left-0 right-0 -top-16 bg-white w-20 h-20 flex justify-center items-center mx-auto rotate-45'>
                    ...
                    <div className=' relative group'>
                        <div className='border-2 duration-300 transition-all group-hover:bg-[#285BDB] absolute left-0 right-0 -top-16 bg-white w-20 h-20 flex justify-center items-center mx-auto rotate-45'>
                            <i className="fas fa-mobile-alt rotate-0 textColor group-hover:text-white text-xl"></i>
                        </div>
                        <div className='border border-gray-800 hover:border-[#285BDB] content py-12 px-4 space-y-2'>
                            <h2 className='text-xl font-semibold'>Latest Smart Phones</h2>
            ...
            <section>
                ...
                <p class="text-center mt-6 hidden" id="see-more">
                    <button className='bgColor text-white py-2 px-5 font-semibold rounded-md' onClick={showAllData} type="button">View All Products</button>
                </p>
            </section>
